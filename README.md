...
|[ScriptedUpdate](https://github.com/TheGreatMisconception/tools/blob/master/Linux/basic-scripted-update.sh)|Scripted Update|
|[Keychron-udev-Rule](https://github.com/TheGreatMisconception/tools/blob/master/Linux/50-keychron-usb.rules)|Allow low-level access to the device required for Keychron Launcher|
